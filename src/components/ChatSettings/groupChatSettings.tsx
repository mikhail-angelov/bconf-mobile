...
class GroupChatSettings extends React.Component<IProps, IState> {
    constructor(props) {
        super(props)
        this.state = {
            ...
            <ChatSettingsWrap>
                ...
                <ChatSettingsView>
                    ...
                    <ChatSettingsItemsWrap>
                        ...
                        <UsersInChatHeader>Users in chat:</UsersInChatHeader>
                        {_.map(chat.activeChat.users, user => {
...
const UsersInChatHeader = styled(Text)`
    font-size: 16;
    font-weight: bold;
`
