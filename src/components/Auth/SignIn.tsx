        ...
        return this.state.showGithubWebview ? (
            <View style={styles.container}>
                ...
                <WebView
                    ...
                    source={{
                        uri: `https://github.com/login/oauth/authorize?client_id=${Config.GITHUB_CLIENT_ID}&scope=user`,
                    }}
                />
            </View>
        ) : (
                    ...
                    <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                        ...
                        <Body>
                            ...
                            <Input
                                ...
                                autoCapitalize="none"
                            />
                            <LoginErrorNotification>{this.props.auth.authError}</LoginErrorNotification>
                            <Button onPress={() => this.handleLogin()} disabled={!this.allFieldsFilled()}>
                                Sign In
                            </Button>
                            <Button onPress={() => this.props.loginFacebook()}>Facebook Login</Button>
                            <Button onPress={() => this.setState({ showGithubWebview: true })}>Github Login</Button>
                            <Link
                                color={BLACK_COLOR}
                                onPress={() => {
