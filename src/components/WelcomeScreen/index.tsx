...
import { View, Image, ScrollView, Dimensions, Animated, ActivityIndicator, Text, TouchableOpacity } from 'react-native'
    ...
    public render() {
        ...
        return (
            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                    ...
                    >
                        {photos.map((item, i) => {
                            return (
                                ...
                                >
                                    <Image style={{ width: width - 100, height: width - 100 }} source={item.image} />
                ...
                <View>
                    <TouchableOpacity onPress={goToAuth} style={{ padding: 50, alignItems: 'center' }}>
